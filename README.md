...
**[URL-Album-2.2.4-beta.zip (3.7 MB)](https://github.com/skljar/url-album-tauri/releases/download/v2.2.4-beta/URL-Album-2.2.4-beta.zip)**

Требования: **Windows 10 / 11** (64-bit) — WebView2 уже встроен.

**Новое в 2.2.4-beta (15 июня 2026):** Корзина — удалённые папки и ссылки теперь попадают в Корзину, их можно восстановить или удалить окончательно. Компактный режим: кнопка в панели инструментов скрывает главное меню. «Переместить в…» — новый пункт контекстного меню. Исправлены дубли превью-картинок. Установка расширения — в README.txt внутри архива.
