...
**[URL-Album-2.3.0-beta.zip](https://github.com/skljar/url-album-tauri/releases/download/v2.3.0-beta/URL-Album-2.3.0-beta.zip)** — Windows 10/11 (64-bit), портативная.
...
**Быстрый доступ**
- Системный трей (показать, добавить из буфера, выход)
...
*Настройки: размер шрифта, горячая клавиша, дерево папок*
...
Tauri 2 + Rust + SQLite + Vanilla JS. Портативный exe ~8 МБ, без внешних зависимостей (WebView2 — системный компонент Windows 10/11).
