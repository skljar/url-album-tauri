...
**[URL-Album-2.2.2-beta.zip (3.8 MB)](https://github.com/skljar/url-album-tauri/releases/download/v2.2.2-beta/URL-Album-2.2.2-beta.zip)**

Требования: **Windows 10 / 11** (64-bit) — WebView2 уже встроен.

**Новое в 2.2.2-beta (8 июня 2026):** автопрокрутка дерева при перетаскивании — список листает сам, когда тянешь к краю панели. Зона «↑ Корень» больше не перекрывает верхнюю папку при перетаскивании. Установка расширения — в README.txt внутри архива.
