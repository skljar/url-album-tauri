...
**[URL-Album-2.2.3-beta.zip (3.8 MB)](https://github.com/skljar/url-album-tauri/releases/download/v2.2.3-beta/URL-Album-2.2.3-beta.zip)**

Требования: **Windows 10 / 11** (64-bit) — WebView2 уже встроен.

**Новое в 2.2.3-beta (13 июня 2026):** перетаскивание для изменения порядка ссылок и папок — теперь и в списке, и в дереве. Имя текущей базы видно над деревом папок. Разные значки на кнопках «Новая папка» и «Новая подпапка». Исправлено: папка «Новые ссылки» больше не пропадает из дерева, импорт ua.dat теперь через диалог выбора файла, ручная сортировка стрелками сохраняется между запусками. Установка расширения — в README.txt внутри архива.
...
- Ссылки попадают в папку «Новые ссылки»
