...
**[URL-Album-2.2.1-beta.zip (3.8 MB)](https://github.com/skljar/url-album-tauri/releases/download/v2.2.1-beta/URL-Album-2.2.1-beta.zip)**

Требования: **Windows 10 / 11** (64-bit) — WebView2 уже встроен.

**Новое в 2.2.1-beta (7 июня 2026):** при сохранении ссылки из браузера теперь можно выбрать папку — расширение показывает список папок из программы, и ссылка сохраняется сразу в нужную. Папка по умолчанию называется «Новые ссылки». Установка расширения — в README.txt внутри архива.
