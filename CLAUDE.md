...
> Полная история ранних сессий и релизов 2.2.0 / 2.2.1 / 2.2.2-beta вынесена в HISTORY.md. Читать оттуда при необходимости.
...
**Всё нижеперечисленное (пп.63-71) ВОШЛО в релиз 2.2.3-beta (13.06.2026), помечен Latest на GitHub.**
...
### Сессия 18 (2026-06-14) — компактный режим, «Переместить в…» → для релиза 2.2.4
**Пп.73+ — после релиза 2.2.3-beta, для следующего релиза (2.2.4).**
